...
# 🚀 Development Deployment Script for Kopran Material Issue Note Print
...
# 🛡️ Step 5: Apply dev-specific configurations
echo ""
echo "🛡️ Step 5: Applying dev-specific configurations..."
